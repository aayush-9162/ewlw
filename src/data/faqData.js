const FAQ_DATA = [
  ...
  },
  {
    ...
    a: 'Each lesson is designed to take about 6\u20138 minutes and is largely conversation-based. Schools are encouraged to conduct one lesson per day, though teachers may conduct more than one lesson if required.'
  },
  {
  ...
  },
  {
    ...
    a: 'While it is recommended to complete all lessons, teachers may adapt the lessons depending on the age group. For younger classes, teachers may choose to cover fewer lessons if needed.'
  },
  {
    q: 'How should teachers conduct the lesson in the classroom?',
    a: 'Lessons are designed to be interactive and discussion-based. Teachers can use the habit poster or presentation, follow the conversation cues in the lesson plan, and encourage students to share their thoughts and experiences.'
  },
  {
  ...
  {
    q: 'How can teachers contribute to this platform?',
    a: 'Teachers are encouraged to upload classroom photos, student posters, short videos, or reels related to habits and skills practiced in school. These contributions help build a shared repository of learning resources for other schools.'
  },
];
