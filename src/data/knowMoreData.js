// Know More content per habit (keyed by habit index 0-based)
const KNOW_MORE_DATA = {
  1: {
    document: {
      title: 'Drink Water Often and Enough (Hydration)',
      sections: [
        {
        ...
        {
          heading: 'What Proper Hydration Supports',
          list: [
        ...
        },
        {
          ...
          text: 'Hydration does not come only from drinking water. Fluids and foods both contribute to daily hydration. Beverages such as water, milk, and other drinks provide fluids, while many foods also contain a high amount of water. Examples include gourd vegetables (bottle gourd, ridge gourd, cucumber), melons (watermelon, muskmelon), tomatoes, and leafy vegetables. Among all sources, plain water remains the best and healthiest option.',
        },
        {
        ...
        },
        {
          ...
          list: [
            ...
            'Limiting caffeinated beverages like excessive tea, coffee, and cola',
          ],
        },
      ],
    },
