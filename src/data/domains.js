...
export const DOMAINS = {
  personal: {
    ...
    clusters: [
      {
        num: '1', word: 'ROUTINE', cls: 'routine', color: '#E87820',
        habits: [
      ...
      {
        num: '2', word: 'HEALTHY', cls: 'healthy', color: '#1A7A40',
        habits: [
      ...
      {
        num: '3', word: 'MINDFUL', cls: 'mindful', color: '#7030A0',
        habits: [
  ...
  social: {
    ...
    clusters: [
      {
        num: '4', word: 'RESPECT', cls: 'respect', color: '#C8A000',
        habits: [
          { n: 22, name: 'Responsible Citizenship', why: 'Understanding rights and responsibilities helps students become active, caring community members.', emoji: '\u{1F3DB}' },
          { n: 23, name: 'Equality & Gender Respect', why: 'Respect for all genders promotes fair, inclusive communities where everyone can thrive.', emoji: '\u{2696}' },
          { n: 24, name: 'Social Skills', why: 'Strong social skills help students build relationships, resolve conflicts and collaborate.', emoji: '\u{1F91D}' },
          { n: 25, name: 'Puberty & Adolescence', why: 'Understanding bodily changes helps students navigate adolescence with confidence.', emoji: '\u{1F331}' },
          { n: 26, name: 'Ethical Use of Media', why: 'Digital literacy and ethical online behaviour help students use technology responsibly.', emoji: '\u{1F4F1}' },
          { n: 27, name: 'Avoid Substance Abuse', why: 'Understanding the risks of substance abuse equips students to make safe, informed choices.', emoji: '\u{1F6AB}' },
          { n: 28, name: 'Tackle Violence & Stay Safe', why: 'Recognising unsafe situations protects students and promotes community safety.', emoji: '\u{1F6E1}' }
        ]
      }
    ]
  },
  planetary: {
    ...
    clusters: [
      {
        num: '5', word: 'SUSTAIN', cls: 'sustain', color: '#1A80C0',
        habits: [
          { n: 29, name: 'Systems Thinking for Web of Life', why: 'Understanding interconnected systems helps students see how their choices affect the planet.', emoji: '\u{1F578}' },
          { n: 30, name: 'Understanding Body & Environment', why: 'The connection between human health and environmental health fosters holistic wellbeing.', emoji: '\u{1FAC0}' },
          { n: 31, name: 'Soil Health & Food Production', why: 'Healthy soil is the foundation of nutritious food, connecting students to their food source.', emoji: '\u{1F331}' },
          { n: 32, name: 'Thoughtful Consumption & Waste', why: 'Mindful consumption and reducing waste protect natural resources for a sustainable future.', emoji: '\u{267B}' },
          { n: 33, name: 'Appreciation of Biodiversity', why: 'Biodiversity underpins food security. Valuing all life builds environmental stewardship.', emoji: '\u{1F98B}' },
          { n: 34, name: 'Interconnected Ecosystems', why: 'Understanding ecosystem links helps students make choices that protect the whole planet.', emoji: '\u{1F310}' },
          { n: 35, name: 'Nurturing Health & Preventing Disease', why: 'Preventing disease through healthy habits and environmental awareness protects communities.', emoji: '\u{1F48A}' }
        ]
      }
    ]
  }
